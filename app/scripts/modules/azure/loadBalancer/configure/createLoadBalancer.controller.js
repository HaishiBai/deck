...
module.exports = angular.module('spinnaker.loadBalancer.azure.create.controller', [
  ...
  require('./azureLoadBalancerAvailabilityZoneSelector.directive.js'),
  ...
  .controller('azureCreateLoadBalancerCtrl', function($scope, $modalInstance, $state, _,
    ...
    this.submit = function () {
      ...
      $scope.taskMonitor.submit(
        function() {
          let params = { cloudProvider: 'azure', providerType: 'azure', loadBalancerName: $scope.loadBalancer.name };
