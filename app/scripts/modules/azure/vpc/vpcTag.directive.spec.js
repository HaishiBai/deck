// 'use strict';
// 
// describe('Directives: vpcAzureTag', function () {
// 
//   var $q, vpcAzureReader;
// 
//   beforeEach(
//     window.module(
//       require('./vpcAzureTag.directive.js'),
//       require('./vpc.read.service.js')
//     )
//   );
// 
//   beforeEach(window.inject(function ($rootScope, $compile, _$q_, _vpcAzureReader_) {
...
//       spyOn(vpcAzureReader, 'getAzureVpcName').and.callFake(function() {
